            ...
            child: ListView(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'Inserisci la data in cui hai piantato';
                    }
                    return null;
                  },
                  readOnly: true,
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'Inserisci la frequenza di innaffiatura';
                    }
                    return null;
                  },
                ),
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'Inserisci la frequenza di potatura';
                    }
                    return null;
                  },
                ),
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'Inserisci la frequenza di travasoa';
                    }
                    return null;
                  },
                ),
